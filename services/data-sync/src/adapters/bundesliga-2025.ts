/**
 * Bundesliga 2025-26 Data Provider Adapter (R16.4, R16.5).
 *
 * Implements the DataProviderAdapter interface using the API-Football service
 * as the external data source for Bundesliga 2025-26 rosters, fixtures, and
 * live scores. Uses the same API-Football provider as World Cup 2026 but with
 * a different league ID — demonstrating competition portability.
 */
 ...
 * Identical to the World Cup adapter — same football statistics source.
 */
...
/**
 * Bundesliga 2025-26 adapter — uses the same API-Football source as World Cup
 * but queries league 78 (Bundesliga 1) for season 2025.
 */
export const bundesliga2025Adapter: DataProviderAdapter = {
